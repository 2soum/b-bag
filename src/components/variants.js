  ...
  return (
    <section id="variants" className="py-20 bg-gray-50">
      <div className="container mx-auto max-w-6xl px-4">
            ...
            <div className="flex border-b">
              <button
                className={`flex-1 py-4 px-6 text-center font-semibold transition-colors ${
                  activeTab === 'fractional' ? 'bg-blue-100 text-blue-800' : 'text-gray-700 hover:bg-gray-50'
                }`}
              ...
              <button
                className={`flex-1 py-4 px-6 text-center font-semibold transition-colors ${
                  activeTab === 'unbounded' ? 'bg-blue-100 text-blue-800' : 'text-gray-700 hover:bg-gray-50'
                }`}
              ...
              <button
                className={`flex-1 py-4 px-6 text-center font-semibold transition-colors ${
                  activeTab === 'multiple' ? 'bg-blue-100 text-blue-800' : 'text-gray-700 hover:bg-gray-50'
                }`}
              ...
              <button
                className={`flex-1 py-4 px-6 text-center font-semibold transition-colors ${
                  activeTab === 'multidimensional' ? 'bg-blue-100 text-blue-800' : 'text-gray-700 hover:bg-gray-50'
                }`}
                ...
                <div className="animate-fadeIn">
                  <div className="flex items-start gap-4">
                    <div className="w-2/3 space-y-4">
                      ...
                      <div className="cursor-pointer border-t border-b py-3 hover:bg-gray-50">
                        <div className="flex justify-between items-center">
                          <h4 className="text-lg font-semibold text-blue-700">Formulation mathématique</h4>
                          <ChevronDown />
                        </div>
                      ...
                      <div className="cursor-pointer border-b py-3 hover:bg-gray-50">
                        <div className="flex justify-between items-center">
                          <h4 className="text-lg font-semibold text-blue-700">Méthode de résolution</h4>
                          <ChevronDown />
                        </div>
        ...
        {/* Bouton pour passer à une autre variante dans la simulation */}
        <div className="mt-8 text-center">
          <button className="flex items-center gap-2 mx-auto bg-blue-700 hover:bg-blue-800 text-white font-semibold py-3 px-6 rounded-md transition-colors shadow-md">
            <Settings size={20} />
            <span>Simuler cette variante</span>
          </button>
          
          <p className="mt-4 text-gray-600">
            Cliquez pour configurer la simulation avec la variante sélectionnée
          </p>
        </div>
      </div>
    </section>
